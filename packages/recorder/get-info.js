...
module.exports = {
  getInfoByRoom: async (roomId) => {
    ...
    try {
      ...
      // FetchError: request to https://api.live.bilibili.com/xlive/web-room/v1/index/getInfoByRoom?room_id=6161127 failed, reason: getaddrinfo ENOTFOUND api.live.bilibili.com
      console.error(e);
  ...
  getPlayUrl: async (roomId) => {
    // https://api.live.bilibili.com/room/v1/Room/playUrl?cid=2064239&quality=4&platform=web
